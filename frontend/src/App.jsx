...
const App = () => {
  ...
  return (
    <div className="App">
      <HomeRoute topicData={topics} photoData={photos} setOpenModal={openModal} setPhotoInfo={setPhotoInfo} iffavData={ifFavouritesExist} favData={favouritesData} state={state}/>
      {state.openModal && <PhotoDetailsModal  setOpenModal={openModal} photoInfo={state.photoInfo} favData={favouritesData} favourites={state.favourites}/>}
    </div> 
  );
};
